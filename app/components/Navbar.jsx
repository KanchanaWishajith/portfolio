...
useEffect(() => {
  ...
  return (
    ...
    flex items-center justify-between bg-white z-50 $ {isScroll ? "bg-white
      bg-opacity-50 backdrop-blur-lg shadow-sw" : ""}`}>
        <a href="#top">
        ...
        <div className='flex items-center gap-4'>
            <button onClick={() => setIsDarkMode(prev => !prev)}>
              <Image src={isDarkMode ? assets.send_icon : assets.moon_icon} alt="" className='w-6'/>
            </button>
